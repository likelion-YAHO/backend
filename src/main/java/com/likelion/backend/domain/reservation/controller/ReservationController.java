...
public class ReservationController {
    ...
    @Operation(summary = "내 예약 목록 조회", description = "사용자의 예약 내역 리스트를 조회합니다.")
    @GetMapping("/my")
    ...
    @Operation(summary = "예약 접수", description = "제품, 매장, 방문 날짜를 선택하여 새로운 수선/업사이클링 예약을 생성합니다.")
    @PostMapping
    ...
    @Operation(summary = "예약 취소", description = "예약 ID를 통해 예약을 취소 상태로 변경합니다.")
    ...
    @Operation(summary = "예약 변경", description = "예약 ID를 통해 방문 날짜나 매장 정보를 수정합니다.")
